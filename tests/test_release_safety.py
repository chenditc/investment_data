...
''',
    ...
    def test_hosted_workflows_bound_resources_and_use_shallow_snapshot_cache(self):
        ...
        self.assertIn("DAILY_UPDATE_RESULT_FILE=/tmp/daily-update-result/result", update)
        self.assertIn('chmod 777 "$update_result_dir"', update)
        self.assertIn(': >"$DAILY_UPDATE_RESULT_FILE"', update)
